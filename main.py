...
def main(config):
    ...
    # Data loader.
    train_loader = get_loader(config.train_data_dir, config.batch_size, num_workers=config.num_workers, 
                              max_load=config.max_load)
    test_loader = TestDataset(config.train_data_dir, src_spk=0, trg_spk=225)
...
if __name__ == '__main__':
    ...
    # Model configuration.
    parser.add_argument('--num_speakers', type=int, default=100, help='dimension of speaker labels')
    ...
    parser.add_argument('--num_iters', type=int, default=900000, help='number of total iterations for training D')
    parser.add_argument('--num_iters_decay', type=int, default=100000, help='number of iterations for decaying lr')
    parser.add_argument('--max_load', type=int, default=10000, help='max training speeches to load')
    ...
    # Directories.
    parser.add_argument("--train_data_dir", type = str, default = '/luoshen/wrb/2020/train')
    parser.add_argument('--wav_dir', type=str, default="/data/th16")
